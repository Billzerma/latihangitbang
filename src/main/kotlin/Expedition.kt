...
fun expedition(berat: Int): String {
    return if (berat <= 1) {
        "Biaya pengiriman adalah Rp 15.000"
    } else if (berat <= 5) {
        "Biaya pengiriman adalah Rp 30.000"
    } else if (berat <= 10) {
        "Biaya pengiriman adalah Rp 50.000"
    } else {
        "Maaf, tidak ada biaya pengiriman yang tersedia untuk berat tersebut."
    }
}